...
{\vspace{-5mm}
\begin{itemize}
\item {Helping to guide development of the PrecisionFDA platform.}
\end{itemize}
}
...
{\vspace{-5mm}
\begin{itemize}
\item {Lead effort to develop a bioinformatics pipeline to support offering the company's IVD assays on a new sequencing platform, thereby substantially expanding market opportunities.}
