...
|               |   * Leveraging a large, multi-'omics dataset to investigate epigenetic mechanisms underlying regulatory variants implicated in type 2 diabetes.  * Developing machine-learning approaches to imputation for multi-'omics data.
* Designed and currently optimizing a novel sequencing assay for single-molecule resolution transcriptome analysis.
...
* Developed user-friendly software tools for QC and pre-processing of NGS reads.
